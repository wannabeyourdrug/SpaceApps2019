        ...
        <form
            ...
            <div class="input-group">
                ...
                <div class="input-group-input">
                    <input type="text" v-model="name" class="text-input">
                </div>
            </div>
            <div class="input-group">
                <div class="input-group-label">
...
<script>
    ...
    function generateName(){
        ...
        let name = capFirst(name1[randomInt(0, name1.length + 1)]) + ' ' + capFirst(name2[randomInt(0, name2.length + 1)]);
        name += Math.random() > 0.5 ? ' ' + romanize(randomInt(1, 15)) : '';
        return name;
    }
